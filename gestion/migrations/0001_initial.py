    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('noRestaurant', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to='gestion.restaurants')),
            ],
        ),
        migrations.AddField(
            model_name='restaurants',
            name='typeRestaurant',
            field=models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to='gestion.typeresto'),
        ),
    ]
